...
from .physical_summary import transform_physical_summary as pt_module
...
def physical_splits(season_id, opta_competition_id, metadata_df, physical_splits_raw, opta_match_id, physical_splits, path=None):
...
def physical_summary(df_fixtures, metadata_df, physical_summary_raw, opta_match_id):
    ...
    summary_df = pt_module.transform_physical_summary(
